...
class ChessBoard(object):
    ...
    def __init__(self, screen, state=None):
        ...
        self.create_chess(state)  # 调用创建棋盘的方法
    ...
    def create_chess(self, board=None):
        """创建默认棋盘上的棋子对象"""
        # 棋子
        if board is None:
            board = self.default_board
        self.chessboard_map = board
        # self.chessboard_map = [
        #     ["", "", "", "", "b_j", "", "", "", ""],
        #     ["", "", "", "", "", "", "", "", ""],
        #     ["", "", "", "", "", "", "", "", ""],
    ...
    def get_team_chess(self, team):
        return [chess for line in self.chessboard_map for chess in line if chess and chess.team == team]
